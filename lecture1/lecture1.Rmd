...
author: Saad Arif <br/>  Dept. of Biological and Medical Sciences & Centre for Functional
  Genomics <br/> Oxford Brookes University <br/> <br/>
  Maria Christodoulo <br/> Department of Statistics <br/> University of Oxford <br/>
...
Day 4(morning only): Introduction to Generalized Linear Models (time permitting), Revision Exercises
...
* A reasonable strategy would reject the null hypothesis if
  $\bar{X_{1}} - \bar{X_{2}}$ was **lesser**/greater than some constant, say $C$
...
* tests that assume an underlying distribution of your data and calculate parameters assuming that distribution (e.g. mean) are called parametric tests

* if your data don't meet the assumptions (e.g. your data is highly non-normal) you can use what are called non-paramteric tests

* example: the Mann-Whitney U test/Wilcoxon test is a a non-parametric alternative for the two sample t-test we just saw.
