...
## Violin or Bee Swarm plots are a much better alternative
```{r, fig.align="center"}
...
## Multiple boxplots for patterns

## Scatterplots for patterns

## Princpal Component Analysis for Patterns (batch effects)

## Princpal Component Analysis for Patterns 

## Cluster Analysis to Look for Groupings in data
