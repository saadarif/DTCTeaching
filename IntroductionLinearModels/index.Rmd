...
```{r, fig.height=6,fig.width=6, eval=F, fig.align="center", warning=FALSE, message=FALSE, linewidth=60}
require(ggplot2)
...
```{r, fig.height=6,fig.width=6, eval=F, fig.align="center", warning=FALSE, message=FALSE, error=F, linewidth=60}
